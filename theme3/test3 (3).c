...
bool inalt[2] = {false, false}; // Track if clients are in the alternate screen
bool inapp[2] = {true, true};       // Track if clients are in application communication mode

// Input Tracking
char kp[2] = {-1, -1};           // Last keypress for each client
...
int tic[2]; // Current input column for each client
...
// Tip Management
int tn[2];                   // Index of the current tip for each client
